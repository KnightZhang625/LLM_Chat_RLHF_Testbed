...
if ddp:
    ...
    # two node three GPUS
    # the WORLD_SIZE should be 6
    # RANK should be: 0, 1, 2, 3, 4, 5
    # LOCAL_RANK should be: 0, 1, 2 | 0, 1, 2
    ...
    seed_offset = 0
    ddp_world_size = 1
tokens_per_iter = block_size * batch_size * gradient_accumulation_steps * ddp_world_size
...
train_data = data[: len(data) * 0.9]
val_data = data[len(data) * 0.9 :]
